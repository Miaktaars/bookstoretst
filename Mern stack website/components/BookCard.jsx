...
export default function BookCard({ book }) {
  const { title, author, price, image, hasAudiobook, hasEbook, isbn } = book;

  // If image is invalid or missing, fall back to no_cover.webp
  ...
  const handleImageError = (e) => {
    if (e.target.src !== "/no_cover.webp") {
      setImgSrc("/no_cover.webp"); // Fallback if image is not found
    }
  };
